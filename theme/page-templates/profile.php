    ...
    <div class="vms-main">
            ...
            <div class="vms-flex vms-items-center vms-justify-between" style="flex-wrap:wrap;gap:1rem;">
                <div>
                    ...
                    <p class="vms-text-sm vms-text-muted" style="margin:0.25rem 0 0;">
                        <?php esc_html_e( 'Update your personal details, change your password, and manage notification preferences.', 'vms-theme' ); ?>
                    </p>
                </div>
            </div>
        </div>

        <div class="vms-grid vms-grid-2 vms-mt-4">
            <!-- Profile Information -->
            <div class="vms-card">
                <div class="vms-card-header">
                    <h2 class="vms-text-lg vms-font-bold"><?php esc_html_e( 'Profile Information', 'vms-theme' ); ?>
                    </h2>
                </div>
                ...
                <form @submit.prevent="updateProfile()">
                    ...
                    <div class="vms-form-group">
                        <label class="vms-flex vms-items-center vms-gap-2">
                            ...
                            <span
                                class="vms-text-sm"><?php esc_html_e( 'Receive SMS notifications', 'vms-theme' ); ?></span>
                        </label>
                    </div>
                    ...
                    <div class="vms-form-group">
                        <label class="vms-flex vms-items-center vms-gap-2">
                            ...
                            <span
                                class="vms-text-sm"><?php esc_html_e( 'Receive email notifications', 'vms-theme' ); ?></span>
                        </label>
                    </div>
                    ...
                    <button type="submit" class="vms-btn vms-btn-primary" :disabled="saving">
                        ...
                        <span
                            x-text="saving ? '<?php esc_attr_e( 'Saving...', 'vms-theme' ); ?>' : '<?php esc_attr_e( 'Update Profile', 'vms-theme' ); ?>'"></span>
                    </button>
                </form>
            </div>
            ...
            <div class="vms-card">
                ...
                <form @submit.prevent="changePassword()">
                    ...
                    <div class="vms-form-group">
                        ...
                        <input type="password" class="vms-input" x-model="passwords.new_password" required
                            minlength="8">
                    </div>
                    ...
                    <button type="submit" class="vms-btn vms-btn-primary" :disabled="changingPassword">
                        ...
                        <span
                            x-text="changingPassword ? '<?php esc_attr_e( 'Changing...', 'vms-theme' ); ?>' : '<?php esc_attr_e( 'Change Password', 'vms-theme' ); ?>'"></span>
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="vms-card vms-mt-4">
            ...
            <table class="vms-table">
                <tbody>
                    <tr>
                        <td class="vms-font-bold" style="width:200px;"><?php esc_html_e( 'Username', 'vms-theme' ); ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><span
                                class="vms-badge vms-badge-info"><?php echo esc_html( ucwords( str_replace( '_', ' ', vms_current_role() ?? 'None' ) ) ); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="vms-font-bold"><?php esc_html_e( 'Member Since', 'vms-theme' ); ?></td>
                        <td><?php echo esc_html( wp_date( get_option( 'date_format' ), strtotime( wp_get_current_user()->user_registered ) ) ); ?>
                        </td>
                    </tr>
                </tbody>
            </table>
