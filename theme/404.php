    ...
    <div class="text-center max-w-md">
        ...
        <div class="relative mb-8">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <svg class="w-24 h-24 text-[var(--vms-primary)]/30" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="<?php echo esc_url( vms_get_dashboard_url_for_role( vms_current_role() ) ); ?>"
            ...
            <?php else : ?>
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="vms-btn vms-btn-secondary">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
